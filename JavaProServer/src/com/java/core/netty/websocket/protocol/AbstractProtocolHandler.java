package com.java.core.netty.websocket.protocol;

import com.alibaba.fastjson.JSONObject;
import com.java.core.netty.websocket.adapter.SubprotocolHandlerAdapter;
    ...
    public void pushMessage(Map<String , Object> params) {
        ...
        if (StringUtils.hasLength(message)) {
            ...
            if (handlerAdapter != null) {
                ...
                messageJson.put("protocol" , MessageUtils.getProtocol(this));
                messageJson.put("message" , message);
                handlerAdapter.sendMessage(protocol ,messageJson.toString() );
            }
        }
    }
