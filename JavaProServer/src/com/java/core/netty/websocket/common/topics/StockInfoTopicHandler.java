...
@WSTopic(topic = "stockInfo")
public class StockInfoTopicHandler extends AbstractTopicHandler {


    @Override
    public void onMessageRecieved(ChannelHandlerContext ctx, WSMessage message) {
        System.out.println(" stockInfo onMessageRecieved : " + message.getContent());
    }

    @Override
    public void onTopicRegistyCompleted(ChannelHandlerContext ctx, WebSocketClient webSocketClient) {
        System.out.println(" stockInfo onTopicRegistyCompleted : -------------" );
